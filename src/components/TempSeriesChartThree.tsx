...
const TempSeriesChartThree: React.FC = () => {
  ...
  useEffect(() => {
    const fetchChartData = async () => {
      try {
        const response = await fetch('https://0ae556e6-5b9a-456f-b3b7-c93463cd36d1.mock.pstmn.io/chart-data/9');
        if (!response.ok) {
...
export default TempSeriesChartThree;