        ...
        >
            <div className="p-4">
                ...
                <ul>
                    ...
                    <li>
                        <Link to="/Menus" onClick={() => setSidebarOpen(false)} className="block py-2 text-gray-700 hover:bg-gray-300">
                            Menús
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link to="/productos" onClick={() => setSidebarOpen(false)} className="block py-2 text-gray-700 hover:bg-gray-300">
                            Productos
                        </Link>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    {user ? (
                        <li>
                            <Link to="/" onClick={() => { setSidebarOpen(false); }} className="block py-2 text-gray-700 hover:bg-gray-300">
